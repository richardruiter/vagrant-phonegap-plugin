      ...
      class Create < Vagrant.plugin("2", :command)
        def execute
          ...
          opts = OptionParser.new do |o|
            o.banner = "Usage: vagrant phonegap create [options] name"
            o.separator ""
            o.separator "Options:"
            o.separator ""
		...
		with_target_vms(['phonegap-box'], reverse: true) do |machine|
		machine.communicate.execute("cd /vagrant/apps/; phonegap create " + name) do |type,data|
		print data
		end
		end
